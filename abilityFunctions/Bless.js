...
module.exports.displayName = "Bless 😇";
module.exports.description = "Bless an ally, buffing thier resist";
module.exports.mpCost = 5;
module.exports.fileName = "Bless.js";

module.exports.buffDisplayName = ["Resist"];
module.exports.buffStatName = ["res"];
