...
module.exports.displayName = "Toss ⚾";
module.exports.description = "Throw something at the enemy, dealing more to Range and Far";
module.exports.mpCost = 5;
module.exports.fileName = "Toss.js"

module.exports.attackAttackingStat = ["atk"];
module.exports.attackDefendingStat = ["def"];
module.exports.attackAbilityMods = {
    "Clash" : {"MoveMod" : 1.5, "HitMod": 75, "CritMod": 1},
    "Sight" : {"MoveMod" : 1.5, "HitMod": 75, "CritMod": 1},
    "Range" : {"MoveMod" : 1.5, "HitMod": 90, "CritMod": 1},
    "Far" : {"MoveMod" : 1.5, "HitMod": 90, "CritMod": 1},
}
