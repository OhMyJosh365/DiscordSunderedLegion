...
module.exports.displayName = "Strike ⚔️";
module.exports.description = "An armed Attack, dealing more damage at closer range.";
module.exports.mpCost = 5;
module.exports.fileName = "Strike.js"

module.exports.attackAttackingStat = ["atk"];
module.exports.attackDefendingStat = ["def"];
module.exports.attackAbilityMods = {
    "Clash" : {"MoveMod" : 1.6, "HitMod": 90, "CritMod": 1},
    "Sight" : {"MoveMod" : 1.5, "HitMod": 85, "CritMod": 1},
    "Range" : {"MoveMod" : 1.5, "HitMod": 75, "CritMod": 1},
    "Far" : {"MoveMod" : 1.5, "HitMod": 75, "CritMod": 1},
}
