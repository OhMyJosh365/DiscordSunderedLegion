...
module.exports.displayName = "Howl 📣";
module.exports.description = "Let out a howl, debuffing an enemy's Magic.";
module.exports.mpCost = 5;
module.exports.fileName = "Howl.js";

module.exports.debuffDisplayName = ["Magic"];
module.exports.debuffStatName = ["mag"];
