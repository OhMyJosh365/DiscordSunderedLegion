...
module.exports.displayName = "Slash 🐾";
module.exports.description = "Swipe at the enemy, with a high crit rate";
module.exports.mpCost = 5;
module.exports.fileName = "Slash.js"

module.exports.attackAttackingStat = ["atk"];
module.exports.attackDefendingStat = ["def"];
module.exports.attackAbilityMods = {
    "Clash" : {"MoveMod" : 1.5, "HitMod": 85, "CritMod": 1.4},
    "Sight" : {"MoveMod" : 1.45, "HitMod": 85, "CritMod": 1.4},
    "Range" : {"MoveMod" : 1.4, "HitMod": 85, "CritMod": 1.4},
    "Far" : {"MoveMod" : 1.4, "HitMod": 85, "CritMod": 1.4},
}
