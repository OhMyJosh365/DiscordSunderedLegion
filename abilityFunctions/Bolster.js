...
module.exports.displayName = "Bolster 🧱";
module.exports.description = "Pep Up an ally, buffing thier Guard";
module.exports.mpCost = 5;
module.exports.fileName = "Bolster.js";

module.exports.buffDisplayName = ["Guard"];
module.exports.buffStatName = ["def"];
