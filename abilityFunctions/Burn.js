...
module.exports.description = "You light a fire on an enemy, giving them Burn.";
module.exports.mpCost = 5;
module.exports.fileName = "Burn.js";

module.exports.statusName = ["Burn"];
module.exports.statusTime = [3];
module.exports.statusHitRate = [60];
module.exports.statusTeamTar = ["Enemies"];


module.exports.targeting = async (interaction, client) => {

    require('../abilityFunctions/abilityCoreFunctions/Status.js').singleTargeting(interaction, client, this.fileName);
...
module.exports.execut = async (interaction, client) => {
    ...
    await require('../abilityFunctions/abilityCoreFunctions/Status.js').execute(interaction, client, this.fileName, desc, curSlot, userTeam, 0);
