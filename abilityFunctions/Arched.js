...
module.exports.displayName = "Arched 🏹";
module.exports.description = "An arched shot at an enemy, dealing more damage farther back";
module.exports.mpCost = 5;
module.exports.fileName = "Arched.js"

module.exports.attackAttackingStat = ["atk"];
module.exports.attackDefendingStat = ["def"];
module.exports.attackAbilityMods = {
    "Clash" : {"MoveMod" : 1.5, "HitMod": 90, "CritMod": 1},
    "Sight" : {"MoveMod" : 1.5, "HitMod": 90, "CritMod": 1},
    "Range" : {"MoveMod" : 1.55, "HitMod": 90, "CritMod": 1},
    "Far" : {"MoveMod" : 1.55, "HitMod": 90, "CritMod": 1},
}
