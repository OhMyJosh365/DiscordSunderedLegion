...
module.exports.displayName = "Distract ❓";
module.exports.description = "Disrupt an enemy, debuffing thier Speed.";
module.exports.mpCost = 5;
module.exports.fileName = "Distract.js";

module.exports.debuffDisplayName = ["Speed"];
module.exports.debuffStatName = ["spd"];
