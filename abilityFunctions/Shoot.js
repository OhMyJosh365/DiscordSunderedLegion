...
module.exports.displayName = "Shoot 🔫";
module.exports.description = "Shoots a projectile, dealing more when target in Range slot.";
module.exports.mpCost = 5;
module.exports.fileName = "Shoot.js"

module.exports.attackAttackingStat = ["atk"];
module.exports.attackDefendingStat = ["def"];
module.exports.attackAbilityMods = {
    "Clash" : {"MoveMod" : 1.45, "HitMod": 85, "CritMod": 1},
    "Sight" : {"MoveMod" : 1.45, "HitMod": 85, "CritMod": 1},
    "Range" : {"MoveMod" : 1.60, "HitMod": 85, "CritMod": 1},
    "Far" : {"MoveMod" : 1.45, "HitMod": 85, "CritMod": 1},
}
