...
module.exports.displayName = "Heal 🩹";
module.exports.description = "Heal an allies wounds";
module.exports.mpCost = 5;
module.exports.fileName = "Heal.js"

module.exports.healStatHealed = ["hp"];
module.exports.healHealingMod = [1.2];
