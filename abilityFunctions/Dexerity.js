...
module.exports.displayName = "Dexerity //";
module.exports.description = "//";
module.exports.mpCost = 50;
module.exports.fileName = "Dexerity.js";

module.exports.buffDisplayName = ["Attack", "Focus"];
module.exports.buffStatName = ["atk", "acc"];
module.exports.buffStrength = [.2, .2];
...
module.exports.execut = async (interaction, client) => {
    ...
    await require('../abilityFunctions/abilityCoreFunctions/Buff.js').execute(interaction, client, this.fileName, desc, curSlot, userTeam, 1);
