...
module.exports.displayName = "Mark 🔍";
module.exports.description = "Expose an enemy's flaw, debuffing thier Resist.";
module.exports.mpCost = 5;
module.exports.fileName = "Mark.js";

module.exports.debuffDisplayName = ["Resist"];
module.exports.debuffStatName = ["res"];
