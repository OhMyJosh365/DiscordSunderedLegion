...
module.exports.displayName = "Backstab 🗡️";
module.exports.description = "Sneak behind the enemy, with high crit to Far";
module.exports.mpCost = 5;
module.exports.fileName = "Backstab.js"

module.exports.attackAttackingStat = ["atk"];
module.exports.attackDefendingStat = ["def"];
module.exports.attackAbilityMods = {
    "Clash" : {"MoveMod" : 1.5, "HitMod": 70, "CritMod": 1},
    "Sight" : {"MoveMod" : 1.5, "HitMod": 70, "CritMod": 1},
    "Range" : {"MoveMod" : 1.5, "HitMod": 80, "CritMod": 1},
    "Far" : {"MoveMod" : 1.5, "HitMod": 90, "CritMod": 1.25},
}
